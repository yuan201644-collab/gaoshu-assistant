...
export const yanxuanChapter1: Question[] = [
  ...
  // ===== 三、解答题（1-6）=====
  {
    id: 'c1-j01', chapter: '第一章 函数、极限、连续', section: '1.4 极限运算法则', type: 'answer',
